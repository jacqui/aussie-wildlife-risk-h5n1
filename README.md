...
* build out simple frontend table of species with basic info
* create card-like components able to reuse in different contexts
* track actual containment efforts and how successful each is
